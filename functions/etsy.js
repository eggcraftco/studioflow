...
// Token encryption
//
// Moved to security/tokenBox.js once Shopify, Square, WooCommerce, QuickBooks,
// Xero, PayPal, the bank feed and Pandle all needed the same envelope. Still
// re-exported from here, because plenty of callers and tests reach for it by
// this name.
// ---------------------------------------------------------------------------

const {
  tokenKeyBytes, tokenKeyId, tokenKeyList, encryptToken, decryptToken, tokenNeedsRebox
} = require("./security/tokenBox");
