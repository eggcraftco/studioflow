...
// Intuit may send the owner's browser here when the app's redirect URI was
// registered as nivadesk.app/quickbooks/callback. The code is exchanged on the
...
const CALLBACK_FUNCTION = "https://europe-west2-eggcraft-studio.cloudfunctions.net/quickbooksOAuthCallback";
...
export default function QuickBooksCallbackPage() {
  ...
  return (
    <main style={{ minHeight: "60vh", display: "grid", placeItems: "center", fontFamily: "system-ui, sans-serif" }}>
      <p style={{ opacity: 0.7 }}>Connecting QuickBooks…</p>
    </main>
  );
}
