...
6. **Google 75151719:** salt-okunur kontrol bu gece mümkün olmadı (console destek sayfası bu Chrome profilinde render olmadı; Cloud Support API projede kapalı — açmak proje değişikliği, yapılmadı). Son bilinen durum: yanıt 10 Eyl ~11:50Z gönderildi, Product Specialist bekleniyor. Sabah console/e-posta dizisinden bakılmalı.
...
| 4. Native feedback ekranları | NATIVE_SUMMARY_PLACEHOLDER | `native-feedback-screens` | NATIVE_TESTS_PLACEHOLDER | deploy/sürüm yok | mağaza kadansı; Mac'ten elle gönderim | #4 |
