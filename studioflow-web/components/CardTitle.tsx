...
const ICON_PATHS: Record<CardIcon, string[]> = {
  ...
  // A page with a pencil on it, not a page. The card is where you write one
  // down; the document mark said "reading" and sat next to a + that meant the
  // opposite. Only the Notes card uses this glyph.
  notes: ["M20 12.5V19a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6.5", "M18.4 3.6a2.1 2.1 0 0 1 3 3L13 15l-4 1 1-4 8.4-8.4Z"],
