...
const ACCEPTABLE_USE_POLICY_DRAFTS: Partial<Record<StudioLanguage, LocalizedAcceptableUseDraft>> = {
  Türkçe: {
    ...
    sectionSummaries: [
      ...
      "Birinin NivaDesk'i kötüye kullandığını, bu politikayı ihlal ettiğini, haklarınızı ihlal ettiğini veya hukuka aykırı içerik yüklediğini düşünüyorsanız yeterli bilgiyle bize yazın: nivadesk@gmail.com. Workspace, kullanıcı, dosya, mesaj, URL, ekran görüntüsü veya sipariş referansı eklemeniz incelemeye yardımcı olur.",
      ...
      "Sorular için: EGGCRAFT LIMITED, 141 Randolph Avenue, London, W9 1DN, United Kingdom. E-posta: nivadesk@gmail.com."
    ]
  },
  Deutsch: {
    ...
    sectionSummaries: [
      ...
      "Melden Sie mutmaßlichen Missbrauch, Rechtsverletzungen oder illegale Inhalte mit ausreichenden Details an nivadesk@gmail.com. Workspace, Nutzer, Datei, Nachricht, URL, Screenshot oder Auftragsreferenz helfen bei der Prüfung.",
      ...
      "Kontakt: EGGCRAFT LIMITED, 141 Randolph Avenue, London, W9 1DN, United Kingdom. E-Mail: nivadesk@gmail.com."
    ]
  },
  Français: {
    ...
    sectionSummaries: [
      ...
      "Pour signaler un abus, une violation de droits ou un contenu illégal, écrivez à nivadesk@gmail.com avec des détails utiles: workspace, utilisateur, fichier, message, URL, capture, référence de commande ou explication.",
      ...
      "Contact: EGGCRAFT LIMITED, 141 Randolph Avenue, London, W9 1DN, United Kingdom. E-mail: nivadesk@gmail.com."
    ]
  }
};
