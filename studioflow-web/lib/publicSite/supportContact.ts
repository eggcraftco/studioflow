...
const SUPPORT_CONTACT_DRAFTS: Partial<Record<StudioLanguage, LocalizedSupportContactDraft>> = {
  Türkçe: {
    ...
    sectionSummaries: [
      ...
      "Hesabınıza erişemiyorsanız veya ticket açamıyorsanız bize contact@nivadesk.co.uk adresinden yazabilirsiniz. E-posta çoğunlukla uygulama içi ticket sistemi kullanılamadığında tercih edilmelidir; ürün ve hesap sorunlarında öncelikli kanal ticket sistemidir.",
      ...
      "EGGCRAFT LIMITED, 141 Randolph Avenue, London, W9 1DN, United Kingdom. E-posta: contact@nivadesk.co.uk. Bu sayfa NivaDesk kullanıcıları için genel destek ve iletişim bilgisi sağlar ve Terms of Service, Privacy Policy, Refund and Cancellation Policy ve Account Deletion Policy ile birlikte okunmalıdır."
    ]
  },
  Deutsch: {
    ...
    sectionSummaries: [
      ...
      "Wenn Sie nicht auf Ihr Konto zugreifen oder kein Ticket öffnen können, schreiben Sie an contact@nivadesk.co.uk. E-Mail sollte hauptsächlich genutzt werden, wenn das In-App-Ticketsystem nicht verfügbar ist.",
      ...
      "EGGCRAFT LIMITED, 141 Randolph Avenue, London, W9 1DN, United Kingdom. E-Mail: contact@nivadesk.co.uk. Diese Seite sollte zusammen mit Terms of Service, Privacy Policy, Refund and Cancellation Policy und Account Deletion Policy gelesen werden."
    ]
  },
  Français: {
    ...
    sectionSummaries: [
      ...
      "Si vous ne pouvez pas accéder à votre compte ou ouvrir un ticket, contactez contact@nivadesk.co.uk. L'e-mail est surtout destiné aux cas où le ticket intégré n'est pas disponible.",
      ...
      "EGGCRAFT LIMITED, 141 Randolph Avenue, London, W9 1DN, United Kingdom. E-mail: contact@nivadesk.co.uk. Cette page doit être lue avec les Terms of Service, Privacy Policy, Refund and Cancellation Policy et Account Deletion Policy."
    ]
  }
};
