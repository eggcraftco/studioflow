...
struct AyarlarView: View {
    ...
    init(startSection: String = "Theme & Brand", canEditWorkspace: Bool = true) {
        ...
        let allowedForReadOnly = ["Account", "Plan & Access", "Team Access", "Theme & Brand", "Language & Labels", "About"]
